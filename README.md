...
<pre>
$ git clone git@github.com:html5hacks/chapter4.git
$ cd chapter4
</pre>

Or [download the latest release](https://github.com/html5hacks/chapter4/archive/master.zip).
...
<pre>
$ git clone git@github.com:[your_github_username]/chapter4.git
$ cd chapter4
</pre>
...
Make sure your current directory is chapter4 before moving to the next step.

<pre>
$ cd [your repos path]/chapter4
</pre>
...
Start the chapter4 demo server from a different terminal window:
